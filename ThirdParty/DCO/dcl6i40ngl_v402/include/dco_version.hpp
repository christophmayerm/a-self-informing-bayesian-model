...
#define DCO_VERSION_SHORT 4.0
#define DCO_VERSION 4.0.2
#define DCO_BRANCH
#define DCO_COMPATIBILITY_VERSION_BASE 360000

#define DCO_VERSION_MAJOR 4
#define DCO_VERSION_MINOR 0
#define DCO_VERSION_PATCH 2
...
template <int T> const std::string build_info_t<T>::VERSION = "4.0.2";
template <int T> const std::string build_info_t<T>::VERSION_SHORT = "4.0";
template <int T> const std::string build_info_t<T>::BRANCH = "";
template <int T> const int build_info_t<T>::VERSION_MAJOR = 4;
template <int T> const int build_info_t<T>::VERSION_MINOR = 0;
template <int T> const int build_info_t<T>::VERSION_PATCH = 2;

...
#define DCO_VERSION_SHORT 3.7
#define DCO_VERSION 3.7.1
#define DCO_BRANCH
#define DCO_COMPATIBILITY_VERSION_BASE 360000

#define DCO_VERSION_MAJOR 3
#define DCO_VERSION_MINOR 7
...
template <int T> const std::string build_info_t<T>::VERSION = "3.7.1";
template <int T> const std::string build_info_t<T>::VERSION_SHORT = "3.7";
template <int T> const std::string build_info_t<T>::BRANCH = "";
template <int T> const int build_info_t<T>::VERSION_MAJOR = 3;
template <int T> const int build_info_t<T>::VERSION_MINOR = 7;
